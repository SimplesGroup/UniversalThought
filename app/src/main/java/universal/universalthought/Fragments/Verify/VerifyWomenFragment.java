...
import universal.universalthought.adapter.VerifyAdapters.VerifyWomenAdapter;
import universal.universalthought.adapter.WomenAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyWomenFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyWomenAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyWomenAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"women",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
