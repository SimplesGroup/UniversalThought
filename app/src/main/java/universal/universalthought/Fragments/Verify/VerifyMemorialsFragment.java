...
import universal.universalthought.adapter.VerifyAdapters.VerifyMemorialsAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyMemorialsFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyMemorialsAdapter adapter;
    ...
    public VerifyMemorialsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyMemorialsAdapter(getActivity(), productList);
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"memorials",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
