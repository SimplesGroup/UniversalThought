...
import universal.universalthought.adapter.VerifyAdapters.VerifyEmergenciesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyEmergenciesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyEmergenciesAdapter adapter;
    ...
    public VerifyEmergenciesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyEmergenciesAdapter(getActivity(), productList);
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"emergenicies",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
