...
import universal.universalthought.adapter.VerifyAdapters.VerifyHumanRightsAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyHumanRightsFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyHumanRightsAdapter adapter;
    ...
    public VerifyHumanRightsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyHumanRightsAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"humanrights",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
