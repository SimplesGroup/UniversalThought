...
import universal.universalthought.adapter.VerifyAdapters.VerifyTechnologyAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyTechnologyFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyTechnologyAdapter adapter;
    ...
    public VerifyTechnologyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyTechnologyAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"technology",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
