...
import universal.universalthought.adapter.VerifyAdapters.VerifyMedicalAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyMedicalFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyMedicalAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyMedicalAdapter(getActivity(), productList);
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"medical",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
