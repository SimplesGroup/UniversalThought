...
import universal.universalthought.adapter.VerifyAdapters.VerifyRuralDevelopmentAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyRuralDevelopmentFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyRuralDevelopmentAdapter adapter;
    ...
    public VerifyRuralDevelopmentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyRuralDevelopmentAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"ruraldevelopment",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
