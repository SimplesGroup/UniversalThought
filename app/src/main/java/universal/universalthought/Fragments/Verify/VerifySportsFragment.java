...
import universal.universalthought.adapter.VerifyAdapters.VerifySportsAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifySportsFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifySportsAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifySportsAdapter(getActivity(), productList);
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"sports",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
