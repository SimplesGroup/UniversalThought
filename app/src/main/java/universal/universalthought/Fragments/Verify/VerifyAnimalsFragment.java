...
import universal.universalthought.adapter.VerifyAdapters.VerifyAnimalsAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyAnimalsFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyAnimalsAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyAnimalsAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"animals",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
