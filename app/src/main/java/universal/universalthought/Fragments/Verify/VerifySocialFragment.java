...
import universal.universalthought.adapter.VerifyAdapters.VerifySocialAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifySocialFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifySocialAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifySocialAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"social",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
