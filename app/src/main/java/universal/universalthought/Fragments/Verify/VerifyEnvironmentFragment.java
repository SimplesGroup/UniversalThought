...
import universal.universalthought.adapter.VerifyAdapters.VerifyEnvironmentAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyEnvironmentFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyEnvironmentAdapter adapter;
    ...
    public VerifyEnvironmentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyEnvironmentAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"environment",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
