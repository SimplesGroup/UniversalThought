...
import universal.universalthought.adapter.VerifyAdapters.VerifyChildrensAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class VerifyChildrensFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static VerifyChildrensAdapter adapter;
    ...
    public VerifyChildrensFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new VerifyChildrensAdapter(getActivity(), productList);
    ...
    private void getData(){
        ...
        productList = cls.jsonmethodverify(getContext(),"childrens",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
