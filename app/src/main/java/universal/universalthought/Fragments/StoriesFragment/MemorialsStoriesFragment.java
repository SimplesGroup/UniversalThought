...
import universal.universalthought.adapter.StoriesPageAdapter.MemorialsStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class MemorialsStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static MemorialsStoriesAdapter adapter;
    ...
    public MemorialsStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new MemorialsStoriesAdapter(getActivity(), productList);
