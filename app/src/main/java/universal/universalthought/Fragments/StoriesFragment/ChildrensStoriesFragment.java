...
import universal.universalthought.adapter.StoriesPageAdapter.ChildrensStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class ChildrensStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static ChildrensStoriesAdapter adapter;
    ...
    public ChildrensStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ChildrensStoriesAdapter(getActivity(), productList);
