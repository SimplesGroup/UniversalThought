...
import universal.universalthought.Response.CheckStoriesClass;
import universal.universalthought.adapter.StoriesPageAdapter.RuralDevelopmentStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class RuralDevelopmentStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static RuralDevelopmentStoriesAdapter adapter;
    ...
    public RuralDevelopmentStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new RuralDevelopmentStoriesAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        CheckStoriesClass cls=new CheckStoriesClass();
        cls.jsonmethod(getContext(),"ruraldevelopment",requestcount);
        productList = cls.jsonmethod(getContext(),"ruraldevelopment",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
