...
import universal.universalthought.adapter.HumanRightsAdapter;
import universal.universalthought.adapter.StoriesPageAdapter.HumanRightsStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class HumanRightsStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static HumanRightsStoriesAdapter adapter;
    ...
    public HumanRightsStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new HumanRightsStoriesAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        cls.jsonmethod(getContext(),"humanrights",requestcount);
        productList = cls.jsonmethod(getContext(),"humanrights",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
