...
import universal.universalthought.adapter.StoriesPageAdapter.OthersStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class OthersStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static OthersStoriesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new OthersStoriesAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        cls.jsonmethod(getContext(),"others",requestcount);
        productList = cls.jsonmethod(getContext(),"others",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
