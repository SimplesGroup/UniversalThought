...
import universal.universalthought.adapter.StoriesPageAdapter.EmergenciesStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class EmergenciesStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static EmergenciesStoriesAdapter adapter;
    ...
    public EmergenciesStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new EmergenciesStoriesAdapter(getActivity(), productList);
