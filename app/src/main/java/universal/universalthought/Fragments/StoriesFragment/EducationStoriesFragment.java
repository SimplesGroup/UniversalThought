...
import universal.universalthought.adapter.StoriesPageAdapter.EducationStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class EducationStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static EducationStoriesAdapter adapter;
    ...
    public EducationStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new EducationStoriesAdapter(getActivity(), productList);
