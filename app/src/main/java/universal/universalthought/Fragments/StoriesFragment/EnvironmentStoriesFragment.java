...
import universal.universalthought.adapter.StoriesPageAdapter.EnvironmentStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class EnvironmentStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static EnvironmentStoriesAdapter adapter;
    ...
    public EnvironmentStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new EnvironmentStoriesAdapter(getActivity(), productList);
