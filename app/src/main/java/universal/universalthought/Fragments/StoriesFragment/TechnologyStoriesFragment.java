...
import universal.universalthought.adapter.StoriesPageAdapter.TechnologyStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class TechnologyStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static TechnologyStoriesAdapter adapter;
    ...
    public TechnologyStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TechnologyStoriesAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        cls.jsonmethod(getContext(),"technology",requestcount);
        productList = cls.jsonmethod(getContext(),"technology",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
