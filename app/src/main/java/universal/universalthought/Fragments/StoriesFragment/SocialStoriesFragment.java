...
import universal.universalthought.adapter.StoriesPageAdapter.SocialStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class SocialStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static SocialStoriesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new SocialStoriesAdapter(getActivity(), productList);
