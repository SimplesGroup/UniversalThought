...
import universal.universalthought.adapter.StoriesPageAdapter.ArtsMediaStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class ArtsMediaStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static ArtsMediaStoriesAdapter adapter;
    ...
    public ArtsMediaStoriesFragment() {
