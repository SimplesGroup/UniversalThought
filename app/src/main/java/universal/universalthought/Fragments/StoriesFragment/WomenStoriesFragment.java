...
import universal.universalthought.adapter.StoriesPageAdapter.WomenStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class WomenStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static WomenStoriesAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new WomenStoriesAdapter(getActivity(), productList);
...
//        adapter.notifyDataSetChanged();
    ...
    private void getData(){
        ...
        cls.jsonmethod(getContext(),"women",requestcount);
        productList = cls.jsonmethod(getContext(),"women",requestcount);
        requestcount++;
        adapter.notifyDataSetChanged();
    }
