...
import universal.universalthought.adapter.StoriesPageAdapter.AnimalsStoriesAdapter;
import universal.universalthought.model.CategoryItemmodel;


public class AnimalsStoriesFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static AnimalsStoriesAdapter adapter;
    private static List<CategoryItemmodel> productList;
    ImageView fundraiser;
    RequestQueue requestqueue;
    int requestcount=1;
    String url="http://www.simples.in/universalthought/test_api/stories_alldata.php";
    String urls="https://androiddevelopmentnew.000webhostapp.com/listjson.json";

    public AnimalsStoriesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new AnimalsStoriesAdapter(getActivity(), productList);
