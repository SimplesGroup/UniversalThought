...
public class TechnologyFragment extends Fragment implements Listinterface {

    private RecyclerView recyclerView;
    private static TechnologyAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TechnologyAdapter(getActivity(), productList);
