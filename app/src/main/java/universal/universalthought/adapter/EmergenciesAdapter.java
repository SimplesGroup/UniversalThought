...
public class EmergenciesAdapter extends RecyclerView.Adapter<EmergenciesAdapter.MyViewHolder> {
    ...
    public EmergenciesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
