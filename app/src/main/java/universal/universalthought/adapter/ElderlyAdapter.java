...
public class ElderlyAdapter extends RecyclerView.Adapter<ElderlyAdapter.MyViewHolder> {
    ...
    public ElderlyAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
