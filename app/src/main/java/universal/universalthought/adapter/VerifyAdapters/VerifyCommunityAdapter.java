...
public class VerifyCommunityAdapter extends RecyclerView.Adapter<VerifyCommunityAdapter.MyViewHolder> {
    ...
    public VerifyCommunityAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
