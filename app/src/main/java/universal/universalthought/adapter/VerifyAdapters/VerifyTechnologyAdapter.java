...
public class VerifyTechnologyAdapter extends RecyclerView.Adapter<VerifyTechnologyAdapter.MyViewHolder> {
    ...
    public VerifyTechnologyAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
