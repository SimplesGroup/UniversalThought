...
public class VerifySocialAdapter extends RecyclerView.Adapter<VerifySocialAdapter.MyViewHolder> {
    ...
    public VerifySocialAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
