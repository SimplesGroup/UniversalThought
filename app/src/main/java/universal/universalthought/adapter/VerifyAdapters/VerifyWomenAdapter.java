...
public class VerifyWomenAdapter extends RecyclerView.Adapter<VerifyWomenAdapter.MyViewHolder> {
    ...
    public VerifyWomenAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
