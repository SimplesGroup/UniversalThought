...
public class VerifyEnvironmentAdapter extends RecyclerView.Adapter<VerifyEnvironmentAdapter.MyViewHolder> {
    ...
    public VerifyEnvironmentAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
