...
public class VerifyOthersAdapter extends RecyclerView.Adapter<VerifyOthersAdapter.MyViewHolder> {
    ...
    public VerifyOthersAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
