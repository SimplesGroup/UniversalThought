...
public class VerifyEmergenciesAdapter extends RecyclerView.Adapter<VerifyEmergenciesAdapter.MyViewHolder> {
    ...
    public VerifyEmergenciesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
