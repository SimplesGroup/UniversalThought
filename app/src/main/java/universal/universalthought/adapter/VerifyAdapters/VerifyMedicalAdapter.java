...
public class VerifyMedicalAdapter extends RecyclerView.Adapter<VerifyMedicalAdapter.MyViewHolder> {
    ...
    public VerifyMedicalAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
