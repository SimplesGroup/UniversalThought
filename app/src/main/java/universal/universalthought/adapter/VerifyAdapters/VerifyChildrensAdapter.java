...
public class VerifyChildrensAdapter extends RecyclerView.Adapter<VerifyChildrensAdapter.MyViewHolder> {
    ...
    public VerifyChildrensAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
