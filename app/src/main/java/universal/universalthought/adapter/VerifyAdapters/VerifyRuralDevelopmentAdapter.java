...
public class VerifyRuralDevelopmentAdapter extends RecyclerView.Adapter<VerifyRuralDevelopmentAdapter.MyViewHolder> {
    ...
    public VerifyRuralDevelopmentAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
