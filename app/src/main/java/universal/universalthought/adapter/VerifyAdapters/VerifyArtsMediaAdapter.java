...
public class VerifyArtsMediaAdapter extends RecyclerView.Adapter<VerifyArtsMediaAdapter.MyViewHolder> {
    ...
    public VerifyArtsMediaAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
