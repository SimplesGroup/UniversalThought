...
public class VerifySportsAdapter extends RecyclerView.Adapter<VerifySportsAdapter.MyViewHolder> {
    ...
    public VerifySportsAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
