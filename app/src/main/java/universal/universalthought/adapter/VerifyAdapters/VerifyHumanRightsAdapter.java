...
public class VerifyHumanRightsAdapter extends RecyclerView.Adapter<VerifyHumanRightsAdapter.MyViewHolder> {
    ...
    public VerifyHumanRightsAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
