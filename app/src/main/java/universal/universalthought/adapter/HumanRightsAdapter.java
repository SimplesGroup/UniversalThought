...
public class HumanRightsAdapter extends RecyclerView.Adapter<HumanRightsAdapter.MyViewHolder> {
    ...
    public HumanRightsAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
