...
public class ArtsMediaAdapter extends RecyclerView.Adapter<ArtsMediaAdapter.MyViewHolder> {
    ...
    public ArtsMediaAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
