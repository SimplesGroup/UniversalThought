...
public class CommunityStoriesAdapter extends RecyclerView.Adapter<CommunityStoriesAdapter.MyViewHolder> {
    ...
    public CommunityStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
