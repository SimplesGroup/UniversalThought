...
public class TechnologyStoriesAdapter extends RecyclerView.Adapter<TechnologyStoriesAdapter.MyViewHolder> {
    ...
    public TechnologyStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
