...
public class AnimalsStoriesAdapter extends RecyclerView.Adapter<AnimalsStoriesAdapter.MyViewHolder> {
    ...
    public AnimalsStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        Log.e("SIZE", productEnglish.getUimage());
