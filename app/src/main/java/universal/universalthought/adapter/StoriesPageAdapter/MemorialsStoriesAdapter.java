...
public class MemorialsStoriesAdapter extends RecyclerView.Adapter<MemorialsStoriesAdapter.MyViewHolder> {
    ...
    public MemorialsStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
