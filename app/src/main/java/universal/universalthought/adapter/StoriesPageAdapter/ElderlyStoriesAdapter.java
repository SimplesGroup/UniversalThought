...
public class ElderlyStoriesAdapter extends RecyclerView.Adapter<ElderlyStoriesAdapter.MyViewHolder> {
    ...
    public ElderlyStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
