...
public class OthersStoriesAdapter extends RecyclerView.Adapter<OthersStoriesAdapter.MyViewHolder> {
    ...
    public OthersStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
