...
public class RuralDevelopmentStoriesAdapter extends RecyclerView.Adapter<RuralDevelopmentStoriesAdapter.MyViewHolder> {
    ...
    public RuralDevelopmentStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
