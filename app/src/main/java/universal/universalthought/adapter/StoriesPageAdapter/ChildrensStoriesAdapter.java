...
public class ChildrensStoriesAdapter extends RecyclerView.Adapter<ChildrensStoriesAdapter.MyViewHolder> {
    ...
    public ChildrensStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
