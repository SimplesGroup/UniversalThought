...
public class SocialStoriesAdapter extends RecyclerView.Adapter<SocialStoriesAdapter.MyViewHolder> {
    ...
    public SocialStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
