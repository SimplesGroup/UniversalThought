...
public class EnvironmentStoriesAdapter extends RecyclerView.Adapter<EnvironmentStoriesAdapter.MyViewHolder> {
    ...
    public EnvironmentStoriesAdapter(Context mContext, List<CategoryItemmodel> productEnglishList) {
