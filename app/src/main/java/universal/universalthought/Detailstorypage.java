...
public class Detailstorypage extends AppCompatActivity {
...
LinearLayout benificiarylayout,campain_layout,cost_layout;
RelativeLayout circlebar_layout;
    /** declaration end of campaign organizer **/

    LinearLayout comment_layouts,Bottom_layout;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_storypage_activity);
       ...
       /* percentage=(TextView)findViewById(R.id.textView_percentage);
        ...
        cost_layout=(LinearLayout)findViewById(R.id.cost_layout) ;
       ...
       /* campaign_organizer_textview_date.setText("16 Aug 2018");
        ...
        button_helpnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Detailstorypage.this, DonatePage.class);
                startActivity(i);
            }
        });
                    ...
                    Log.e("DE","data"+jsonArray.toString());
                      ...
                      //  model.setPhoto(explrObject.getString("fundraiser_photo"));
                       ...
                       // currentdonated_cost.setText("Raised of Rs,"+explrObject.getString("amount_raised")+"goal");
                            currentdonated_cost.setVisibility(View.GONE);
                        title.setText(explrObject.getString("title"));
                            ...
                            percentage_circularbar.setProgress(percentage_value);

                            percentage_circularbar.setMax(100);*/
                           // percentage_circularbar.setVisibility(View.GONE);
                            ...
                            networkImageView_image_post.setImageUrl(explrObject.getString("image"),imageLoader);
...
campain_layout.setVisibility(View.GONE);
                            benificiarylayout.setVisibility(View.GONE);
